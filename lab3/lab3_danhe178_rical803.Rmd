...
#Moderaterna
hist(voteprior[,1], main = "Moderaterna")
abline(v = 0.2333, col = "blue")

#Folkpartiet
hist(voteprior[,2], main = "Folkpartiet")
abline(v = 0.0542, col = "blue")

#Centerpartiet
hist(voteprior[,3], main = "Centerpartiet")
abline(v = 0.0611, col = "green")

#Kristdemokratera
hist(voteprior[,4], main = "Kristdemokraterna")
abline(v = 0.0457, col = "blue")

#Socialdemokraterna
hist(voteprior[,5], main = "Socialdemokraterna")
abline(v = 0.3101, col = "red")

#Vänsterpartiet
hist(voteprior[,6], main = "Vänsterpartiet")
abline(v = 0.0572, col = "red")

#Miljöpartiet
hist(voteprior[,7], main = "Miljöpartiet")
abline(v = 0.0689, col = "green")

#Sverigedemokraterna
hist(voteprior[,8], main = "Sverigedemokraterna")
abline(v = 0.1286, col = "blue")

#Feministiskt initiativ
hist(voteprior[,9], main = "Feministiskt initiativ")
abline(v = 0.0312, col = "pink")
```

## b)

2017-jun 	Sifo 	M: 15.9 	L: 6.2 	C: 13.4 	KD: 2.9 	S: 29.2 	V: 7.7 	MP: 4.0 	SD: 18.0 	FI: 2.1 	(UNCERTAIN: 11.7)
